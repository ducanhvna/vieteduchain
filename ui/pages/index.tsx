  ...
  return (
    <div style={{ padding: 32 }}>
      ...
      <ul>
        ...
        <li><Link href="/nodeinfo">Thông tin node (danh sách node có quyền)</Link></li>        <li><Link href="/eduadmission">Tuyển sinh minh bạch (EduAdmission)</Link></li>
        <li><Link href="/edumarket">EduMarket – Course NFT Marketplace</Link></li>
        <li><Link href="/ledger">Blockchain Ledger - Transaction History</Link></li>
        <li><Link href="/certificates">Certificate Management</Link></li>
        <li><Link href="/course-completion">Course Completion & Certification</Link></li>
        <li><Link href="/degree-issuance">Degree Issuance & Requirements</Link></li>
      </ul>
